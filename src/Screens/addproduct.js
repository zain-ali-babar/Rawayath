  ...
  return (
    <div className="add-product">
      ...
      <div className="middle_content">
        ...
        <div>
          <span style={{ fontWeight: "bold", width: "50%" }}>Note:</span> Colors
          available for the given size should be written sperated by commas.
          Quantitites of each color should be written in the same order as the
          colors.
        </div>
