              ...
              <div className="list-box">
                <div style={{ textAlign: "left" }}>
                  ...
                  {item.map((item1, index) => {
                    return <div style={{ fontSize: "1.8rem" }}>-{item1.name}</div>;
                  })}
                </div>
                <div>
                  <button
                    value={"Approve"}
                    onClick={(event) => db.collection('order').doc(x.order_id).update(
                      {
              ...
              <div className="list-box">
                ...
                <div style={{ padding: "6rem" }}>
                  ...
                  <select
                    ...
                    value={status}
                    onChange={(event) => db.collection('order').doc(x.order_id).update(
                      {
